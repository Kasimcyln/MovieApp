...
public class FavoriteAdapter extends RecyclerView.Adapter<FavoriteAdapter.TvShowsViewHolder> {

    private List<TVShow> tvShows = new ArrayList<>();
    private LayoutInflater layoutInflater;
    private final FavoriteListener favoriteListener;

    public FavoriteAdapter(FavoriteListener favoriteListener) {
    ...
    class TvShowsViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bindTVShow(TVShow tvShow) {
            ...
            itemContainerTvShowBinding.getRoot().setOnClickListener(view -> favoriteListener.onTVShowClicked(tvShow));
        }
    }
}
